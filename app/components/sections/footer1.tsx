...
const Footer1 = () => {
    return (
        <footer className="mt-20 tablet:mt-0 relative h-[1000px] tablet:h-[787px] w-full flex justify-center footer-wrapper overflow-hidden px-[20px] tablet:px-[30px] laptop:px-[50px] desktop:px-[70px]">
            {/* Background */}
      ...
      "
            ...
            {/* Content */}
            <div className="absolute bottom-0 z-10 h-[1000px] w-full px-6 tablet:px-[30px] tablet:max-w-[900px] laptop:max-w-[1228px] mx-auto flex flex-col justify-end gap-y-10 tablet:gap-y-30">
                <div className={`h-full tablet:h-[361px] w-full flex flex-col items-center justify-center tablet:flex-row gap-4 laptop:gap-6`}>
                    ...
                    <div className={`p-4 tablet:p-6 laptop:p-8 w-full max-w-[450px] tablet:max-w-full border border-[#EDEDED] bg-[#FAF9F8] rounded-[14px] tablet:w-2/3 flex-1 tablet:h-full`}>
                        <div className={`w-full h-full flex flex-col gap-y-6 justify-between`}>
                            <div className={`flex flex-col gap-y-10 items-center tablet:items-start tablet:flex-row tablet:justify-between`}>
                                {
                                    items.map((e, i) => (
                                        <div key={i} className={`flex flex-col items-center tablet:items-start gap-y-5`}>
                                            ...
                                            <div className={`flex flex-col gap-y-2.5 text-center tablet:text-start`}>
                                                {
                                                    e.list.map((li, index) => (
                            ...
                            <div className={`w-full`}>
                                <div className={`w-full flex flex-col tablet:flex-row gap-y-3 items-center justify-center tablet:justify-between`}>
                                    ...
                                    <div className={`flex gap-x-1`}>
                                        <div className={`bg-[#C6C6C6] hover:bg-[#C6C6C6]/80 cursor-pointer flex items-center justify-center h-7 tablet:h-8 w-7 tablet:w-8 rounded-lg`}>
                ...
                <div className={`-mb-[10px] tablet:-mb-15 laptop:-mb-18`}>
