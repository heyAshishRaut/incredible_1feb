...
const Faq = () => {
    ...
    return (
        <div className={`w-full p-[20px] tablet:p-[40px] laptop:p-[100px] desktop:p-[120px]`}>
            <div className={`w-full flex flex-col gap-y-[20px] items-center tablet:gap-y-[40px] laptop:gap-y-[60px] desktop:gap-y-[70px]`}>
                <div className={`w-full tablet:max-w-[550px] flex flex-col gap-y-[16px] items-center p-[10px]`}>
                    ...
                    <div className={`font-grotesk font-medium text-[22px] tablet:text-[26px] laptop:text-[36px] leading-[128%] tracking-[-2%] desktop-[43px]`}>Frequently
                        Asked Questions
                    </div>
                </div>
                ...
                <div className="w-full flex flex-col items-center gap-y-[14px]">
                        ...
                        return (
                            ...
                            >
                                <div className="select-none w-full tablet:w-[591px] flex flex-col gap-y-5">
                                    <div className="font-grotesk font-medium leading-[120%] tracking-[-1%] text-[14px] tablet:text-[18px] desktop:text-[22px]">
                                        {e.question}
                                    </div>
                    ...
                    <div className={`w-full max-w-[450px] tablet:max-w-[600px] laptop:max-w-[740px] desktop:max-w-[880px] flex items-center justify-between gap-x-[10px] tablet:gap-x-0 p-[10px] tablet:p-5`}>
                        <div className={`font-grotesk font-medium leading-[120%] tracking-[-1%] text-[14px] tablet:text-[18px] desktop:text-[22px]`}>Still have questions? We're here to help!</div>
                        <div className={`h-[50px] tablet:h-[55px] min-w-[110px]  tablet:min-w-[130px] p-1 rounded-full bg-[#0D2247]/5 border border-[#0D2247]/10`}>
                            <div className={`h-full w-full bg-[#27292F] rounded-full flex items-center justify-center cursor-pointer`}>
                                <div className={`font-grotesk text-[12px] tablet:text-[15px] leading-[125%] tracking-[-2%] text-white`}>Contact Us</div>
                            </div>
                        </div>
                    </div>
                </div>
