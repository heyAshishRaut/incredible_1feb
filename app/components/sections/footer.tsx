...
import footerBg from "@/public/footer2.png"
...
const Footer = () => {
    return (
        ...
        tablet:h-auto
        tablet:aspect-[1440/787]

        px-[20px] pt-[20px]
        tablet:px-[40px] tablet:pt-[40px]
        laptop:px-[100px] laptop:pt-[100px]
        desktop:px-[120px]
        "
        >
            <div
            ...
            <div className="relative z-20 w-full max-w-[1228px] h-full tablet:h-[320px] laptop:h-[361px] flex flex-col items-center tablet:flex-row gap-6 desktop:gap-x-8 mx-auto">
                <div className={`relative w-full max-w-[450px] tablet:w-[320px] laptop:w-[361px] desktop:w-1/3 h-[300px] tablet:h-[350px] laptop:h-[400px]`}>
                    <Image src={footer1} alt="" fill className={`absolute bg-contain bg-center rounded-[14px]`} />
                ...
                laptop:h-[400px]
                ">
                    <div className={`w-full h-full flex flex-col gap-y-5 tablet:gap-y-5 tablet:flex-row items-center tablet:items-start justify-start tablet:justify-between`}>
                        {
                            items.map((e, i) => (
                                <div key={i} className={`flex flex-col items-center tablet:items-start gap-y-2 tablet:gap-y-5`}>
                                    <div className={`font-grotesk font-medium leading-[100%] tracking-[-1%] text-[14px] tablet:text-[14px] laptop:text-[16px]`}>{e.title}</div>
                                    <div className={`flex flex-col items-center tablet:items-start gap-y-1.5 tablet:gap-y-2.5`}>
                                        {
                                            e.list.map((it, index) => (
                                                <div key={index} className={`text-[14px] laptop:text-[16px] font-grotesk text-[#666] leading-[150%] tracking-[-2%]`}>
                                                    <div>{it.name}</div>
                                                </div>
                                            ))
                                        }
                    ...
                    <div className={`w-full flex flex-col tablet:flex-row gap-y-3 items-center justify-center tablet:justify-between`}>
                        ...
                        <div className={`flex gap-x-1`}>
                            <div className={`bg-[#C6C6C6] flex items-center justify-center h-7 tablet:h-8 w-7 tablet:w-8 rounded-lg`}>
                                <svg className={`h-3 w-3 tablet:h-4 tablet:w-4`} viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className={`bg-[#C6C6C6] flex items-center justify-center h-7 tablet:h-8 w-7 tablet:w-8 rounded-lg`}>
                                <svg className={`h-3 w-3 tablet:h-4 tablet:w-4`} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11.7491 8.84615L17.328 2.5H14.8303L10.5819 7.25385L6.91714 2.54615L1.66504 2.5L7.80416 10.5538L2.06186 17.3385H4.55953L9.13469 12.2615L13.1496 17.4538L18.3317 17.5L11.7491 8.84615ZM4.55953 3.93077H6.14683L15.2972 15.9538H13.8266L4.55953 3.93077Z" fill="#626262"/>
                                </svg>

                            </div>

                            <div className={`bg-[#C6C6C6] flex items-center justify-center h-7 tablet:h-8 w-7 tablet:w-8 rounded-lg`}>
                                <svg className={`h-3 w-3 tablet:h-4 tablet:w-4`} viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.2 5.875C6.91134 5.875 5.86667 6.91967 5.86667 8.20834C5.86667 9.497 6.91134 10.5417 8.2 10.5417C9.48867 10.5417 10.5333 9.497 10.5333 8.20834C10.5356 7.58882 10.2904 6.99403 9.85237 6.55596C9.41431 6.11789 8.81952 5.87278 8.2 5.875Z" fill="#626262"/>
